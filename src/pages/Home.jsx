...
const Home = () => {
  ...
  return (
    <div className="relative overflow-hidden min-h-screen h-full flex items-center justify-center bg-neutral-900 text-slate-200">
      <div className="absolute w-52 h-52 bg-purple-500/50 top-5 -right-20 rounded-full filter blur-3xl  "></div>
      <div className="absolute w-96 h-96 bg-teal-500 top-29 -left-40 rounded-full filter blur-2xl opacity-10  "></div>
      <div className="absolute w-96 h-96 bg-sky-500 -bottom-2 -right-20 rounded-full filter  blur-2xl opacity-10 "></div>
      <form
